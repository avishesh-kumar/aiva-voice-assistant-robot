...
if __name__ == "__main__":
    ...
    # --- MODIFIED ---
    # Test new SET_SAFETY_MODE command
    safety_cmd = {"type": "SET_SAFETY_MODE", "mode": "AUTONOMOUS", "timestamp": 1234567890}
    framed_safety = encode_message(safety_cmd)
    print(f"\nSET_SAFETY_MODE command encoded: {len(framed_safety)} bytes")
    print(f"Payload: {framed_safety[4:].decode('utf-8')}")
    # --- END MODIFIED ---
